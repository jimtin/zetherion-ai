  ...
  "unit-full": {
    ...
    command: [
      ...
      [
        ...
        "scripts/docker-python-tool.sh -m coverage report > .artifacts/coverage/unit-full-coverage-report.txt",
        "scripts/docker-python-tool.sh scripts/testing/coverage_gate.py --artifacts-dir .artifacts/coverage/unit-full --coverage-file .coverage --lane-id unit-full --minimum-statements 90 --minimum-lines 90 --minimum-branches 90 --minimum-functions 90",
      ].join(" && "),
    ],
  },
  "api-integration-coverage": {
    ...
    command: [
      "bash",
      "-lc",
      "scripts/docker-python-tool.sh -m pytest tests/integration/test_api_http.py tests/integration/test_skills_http.py tests/integration/test_agent_skills_http.py -m 'integration and not optional_e2e' -q --tb=short --no-cov",
    ],
  },
  "e2e-mocked": {
    ...
    command: [
      "bash",
      "-lc",
      "scripts/docker-python-tool.sh -m pytest tests/integration/test_dev_watcher_e2e.py tests/integration/test_milestone_e2e.py -m 'integration and not optional_e2e' -q --tb=short",
    ],
  },
  "e2e-fullstack-critical": {
