  ...
  "unit-full": {
    ...
    command: [
      ...
      [
        ...
        "scripts/repo-python-tool.sh -m coverage report > .artifacts/coverage/unit-full-coverage-report.txt",
        "scripts/repo-python-tool.sh scripts/testing/coverage_gate.py --artifacts-dir .artifacts/coverage/unit-full --coverage-file .coverage --lane-id unit-full --minimum-statements 90 --minimum-lines 90 --minimum-branches 90 --minimum-functions 90",
      ].join(" && "),
    ],
  },
  "api-integration-coverage": {
