...
- Worker delegation grant routes were added for scoped repo/Codex control:
  - `GET /service/ai/v1/internal/admin/tenants/{tenant_id}/workers/delegation/grants`
  - `PUT /service/ai/v1/internal/admin/tenants/{tenant_id}/workers/nodes/{node_id}/delegation/grants`
  - `DELETE /service/ai/v1/internal/admin/tenants/{tenant_id}/workers/delegation/grants/{grant_id}`
